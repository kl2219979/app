export const SettingsView = {
    render() {
        return `
            <div class="w-full max-w-2xl space-y-5 sm:space-y-8 animate-fade-in">
                <section class="glass-card p-4 sm:p-6 rounded-2xl space-y-4">
                    ...
                    <form id="profile-form" onsubmit="window.saveProfile(event)" class="space-y-3">
                        ...
                        <button type="submit" class="w-full sm:w-auto px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl text-sm font-semibold">Guardar perfil</button>
                    </form>
                </section>
                ...
                <section class="glass-card p-4 sm:p-6 rounded-2xl space-y-4">
                    ...
                    <div id="mfa-setup-box" class="hidden space-y-3">
                        ...
                        <div class="flex flex-col gap-2 sm:flex-row">
                            ...
                            <button type="button" onclick="window.confirmMfaSetup()" class="w-full sm:w-auto px-4 py-2 bg-emerald-600/80 hover:bg-emerald-600 text-white rounded-xl text-sm font-semibold">Confirmar</button>
                        </div>
                    </div>
                    <button type="button" id="btn-mfa-setup" onclick="window.startMfaSetup()" class="w-full sm:w-auto px-4 py-2 border border-indigo-500/30 text-indigo-400 rounded-xl text-sm font-semibold">
                        Configurar MFA
                    </button>
                </section>

                <section class="glass-card p-4 sm:p-6 rounded-2xl space-y-3 border border-rose-500/20">
                    ...
                    <button type="button" onclick="window.deactivateOwnAccount()" class="w-full sm:w-auto px-4 py-2 border border-rose-500/40 text-rose-400 hover:bg-rose-500/10 rounded-xl text-sm font-semibold">
